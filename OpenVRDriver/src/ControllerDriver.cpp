#include "../include/ControllerDriver.h"
...
void ControllerDriver::RunFrame()
{
	...
	VRDriverInput()->UpdateScalarComponent(JoystickXHandle, 0.95f, 0.0);
	VRDriverInput()->UpdateScalarComponent(TrackpadXHandle, 0.95f, 0.0);
}

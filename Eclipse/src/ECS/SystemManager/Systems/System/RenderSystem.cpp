...
{
  // Scene View
  DrawBuffers(engine->gGraphics.mRenderContext.m_frameBuffer->GetGameViewBuffer());

  // Game View
  DrawSecondBuffers(engine->gGraphics.mRenderContext.n_frameBuffer->GetGameViewBuffer());

...
//        InsertAllKeys();
//
//        KeyMappings.emplace("Hello", InputKeycode::Key_RIGHT);
//    }
//
//    void InputWrapper::InsertAllKeys()
//    {
...
//    }
//
//    std::vector<std::string> InputWrapper::GetAllKeys()
//    {
//        return AllInputs;
//    }
//
...
//    }
//
//    std::string InputWrapper::GetInputString(const InputKeycode keycode)
//    {
//        switch (keycode)
//        {
//        case InputKeycode::Key_Null:
...
//        HoldKeyContainer.insert({ InputKeycode::Key_Null,std::pair<bool,InputState>(false,InputState::Key_NULLSTATE) });
//    }
//
...
//
//        //std::cout << "Insert How Many Times " << std::endl;
//        //LogicalInputContainer.push_back({ std::pair<InputKeycode,std::pair<bool, InputState>>(keycode,std::pair<bool,InputState>(flag,input)) });
//    }
//
...
//    }
//
//    void InputWrapper::RemoveKey(LogicalKeyIT input)
//    {
//        LogicalInputContainer.erase(input);
//    }
//
...
//    {
//        //glfwSetKeyCallback(OpenGL_Context::GetWindow(), on_key_callback);
//
...
//            bool single = false;
//
//            // If yes , we register SPACE in our container
...
//            //
//            //    // If Space is Pressed Before , we dont come in again.
//            //    if (SingleFlag)
//            //        continue;
//            //
//            //    PrintKey(Message, Press);
//            //
//            //    // Set Space is pressed = to true
//            //    SingleFlag = true;
//            //
//            //    // Now we return SPACE IS PRESSED ONCE
//            //    return true;
//            //}
//        }
...
//namespace Eclipse
//{
//    bool InputWrapper::GetKeyTriggered(std::string NewMap)
//    {
//        int Press = GetKey(CheckMappingExist(NewMap));
//
//        if (IsKeyPressed(Press))
//        {
//            bool single = false;
//
//            RegisterTriggerInput(CheckMappingExist(NewMap), Press, single, InputState::Key_PRESSED);
//
//            for (auto& pair2 : KeyContainer)
//            {
//                auto& Message = (pair2.first);
...
//        else if (IsKeyReleased(Press))
//        {
//            GetKeyReleased(CheckMappingExist(NewMap));
//            return false;
//        }
//
//        return false;
//    }
//
//    bool InputWrapper::GetKeyCurrent(std::string NewMap)
//    {
//        Update();
//
//        int Hold = GetKey(CheckMappingExist(NewMap));
//
//        if (IsKeyPressed(Hold))
//        {
//            bool single = false;
//            RegisterHoldInput(CheckMappingExist(NewMap), Hold, single, InputState::Key_HOLD);
//        }
//        else if (IsKeyReleased(Hold))
//        {
//            GetHoldKeyReleased(CheckMappingExist(NewMap));
//            return false;
//        }
//
//        return false;
//    }
//
//    InputKeycode InputWrapper::CheckMappingExist(std::string NewMap)
//    {

...
namespace Eclipse
{
    ...
    DynamicAABBTree::Aabb DynamicAABBTree::Aabb::Combine(const Aabb& lhs, const Aabb& rhs)
    {
        ...
        result.mMin.x = static_cast<float>((std::min)(lhs.mMin.x, rhs.mMin.x));
        result.mMax.x = static_cast<float>((std::max)(lhs.mMax.x, rhs.mMax.x));

        result.mMin.y = static_cast<float>((std::min)(lhs.mMin.y, rhs.mMin.y));
        result.mMax.y = static_cast<float>((std::max)(lhs.mMax.y, rhs.mMax.y));

        result.mMin.z = static_cast<float>((std::min)(lhs.mMin.z, rhs.mMin.z));
        result.mMax.z = static_cast<float>((std::max)(lhs.mMax.z, rhs.mMax.z));

...
namespace Eclipse
{
    ...
    void EngineCompiler::LoadGeometry()
    {
        ...
        for (unsigned int i = 0; i < TotalNumberOfModels; i++)
        {
            ...
            if (strcmp(name.c_str(), "LightBulb") != 0 
                && strcmp(name.c_str(), "SpotLight") != 0 
                && strcmp(name.c_str(), "Inner") != 0 
                && strcmp(name.c_str(), "Outer") != 0
                && strcmp(name.c_str(), "AdditionalCube") != 0)
            {
    ...
    void EngineCompiler::LoadPrefabs()
    {
        ...
        for (int i = 0; i < TotalNumberOfPrefabs; i++)
        {
            ...
            if (strcmp(ParentName.data(), "LightBulb") != 0 
                && strcmp(ParentName.data(), "SpotLight") != 0 
                && strcmp(ParentName.data(), "Inner") != 0 
                && strcmp(ParentName.data(), "Outer") != 0
                && strcmp(ParentName.data(), "AdditionalCube") != 0)
            {

...
namespace Eclipse
{
	bVRRenderModel::bVRRenderModel(const std::string& sRenderModelName)
	{
		m_glIndexBuffer = 0;
		m_glVertArray = 0;
		m_glVertBuffer = 0;
	...
	bool bVRRenderModel::BInit(const RenderModel_t& vrModel, const RenderModel_TextureMap_t& vrDiffuseTexture)
	{
		...
		glBufferData(GL_ARRAY_BUFFER, 
			sizeof(RenderModel_Vertex_t) * vrModel.unVertexCount, 
